...
An MCP (Model Context Protocol) server specialized for **Data Flow Diagrams**. Enables AI assistants like Claude to programmatically create and manage data flow diagrams — external entities, processes, data stores, and data flows in [StarUML](https://staruml.io/).

<p align="center">
  <img src="images/main.jpg" alt="AI-generated Food Delivery System DFD in StarUML via MCP" width="800">
  <br>
  <em>AI creating a complete Food Delivery System DFD through MCP tools</em>
</p>

## Architecture

<p align="center">
  <img src="images/architecture.svg" alt="Architecture: Claude ↔ MCP (stdio) ↔ staruml-controller-dfd-mcp ↔ HTTP REST API ↔ StarUML" width="800">
</p>
